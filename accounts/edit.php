...
<tr>
	...
	<td>
		<select name="is_away">
		<option value="1"<?php if ($row['is_away']==1) {
            echo ' selected="selected"';
} ?>>yes</option>
		<option value="0"<?php if ($row['is_away']==0) {
            echo ' selected="selected"';
} ?>>no</option>
		</select>
	</td>
...
<tr>
	...
	<td>
		...
		<option <?php if ($row['spam_check']=='yes') {
            echo("selected");
} ?>>yes</option>
		<option <?php if ($row['spam_check']=='no') {
            echo("selected");
} ?>>no</option>
		</select>
	</td>
...
<tr>
	...
	<td>
		...
		<option <?php if ($row['spam_purge']=='yes') {
            echo("selected");
} ?>>yes</option>
		<option <?php if ($row['spam_purge']=='no') {
            echo("selected");
} ?>>no</option>
		</select><br>
...
<tr>
	...
	<td>
		...
		<option <?php if ($row['virus_check']=='yes') {
            echo("selected");
} ?>>yes</option>
		<option <?php if ($row['virus_check']=='no') {
            echo("selected");
} ?>>no</option>
		</select>
	</td>
...
<tr>
	...
	<td>
		...
		<option <?php if ($row['is_enabled']=='yes') {
            echo("selected");
} ?>>yes</option>
		<option <?php if ($row['is_enabled']=='no') {
            echo("selected");
} ?>>no</option>
		</select>
	</td>
